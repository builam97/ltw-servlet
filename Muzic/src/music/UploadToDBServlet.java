...
public class UploadToDBServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		RequestDispatcher dispathcher = request.getServletContext().getRequestDispatcher("/jsps/uploadToDB.jsp");
			...
			conn.setAutoCommit(false);
			 ...
			 for(Part part: request.getParts()) {
			  ...
			  conn.commit();
	           ...
	           RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/jsps/uploadToDB.jsp");
